...
public class ATMSGranule extends Granule {
	...
	public static void setBaseTimeSet(boolean baseTimeSet) {
		ATMSGranule.baseTimeSet = baseTimeSet;
	}
	...
	public static void setBaseTime(long baseTime) {
		...
		ATMSGranule.baseTime = baseTimeEvenSecond;
		System.out.println("Set ATMS baseTime="+ATMSGranule.baseTime);
		ATMSGranule.baseTimeSet = true;
	}
	 ...
	 */
	public ATMSGranule(RawApplicationPackets rap,
					long orbit,
					GranuleId granuleId,
					LEOAFlag leoaState,
					String docName,
	 ...
	 */
	public ATMSGranule(int groupId, String granuleName) throws RtStpsException {
	...
	public static  long getEndBoundary(long arbitraryTime)
	{
		 ...
		 // ----------------------------------------------------------------------
		   ...
		   System.out.println("ATMS granule ID="+granuleIDValue);
		   // Multiply the granule number by the granule size, then add the spacecraft
		   // base time to obtain the granule start boundary time. Add the granule
		   // size to the granule start boundary time to obtain the granule end
		   // boundary time.
