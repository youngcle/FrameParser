 ...
 *
 */
public class ROTCS_RDR extends RDR {
	 ...
	 */
	public ROTCS_RDR(AllData allData, DataProducts dataProds, FixedDomainDescription dev, int scansPerGranule) throws RtStpsException {
		super(null, RDRName.OMPS_TCScience, allData, dataProds, dev);
		System.out.println("OMPS RDR creation started.");
		this.scansPerGranule = scansPerGranule;
	}
	

	public ROTCS_RDR(Stats stats, AllData allData, DataProducts dataProds, FixedDomainDescription dev, int scansPerGranule) throws RtStpsException {
		super(stats, RDRName.OMPS_TCScience, allData, dataProds, dev);
		if (stats == null) {
			System.out.println("OMPS RDR creation started.");
		}
		this.scansPerGranule = scansPerGranule;
	...
	protected RawApplicationPackets createRawApplicationPackets(RDRName rdrName) {
		...
		RawApplicationPackets rap = new ROTCSRawApplicationPackets(stats, SpacecraftId.npp, getSetNum(), scansPerGranule, getPacketPool());
