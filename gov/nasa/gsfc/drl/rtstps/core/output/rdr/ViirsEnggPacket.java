...
/**
 * Support some aspects of a VIIRS Calibration Packet, mainly helper method(s)
...
public class ViirsEnggPacket {
	/**
	 * Given a known VIIRS engineering packet, return the scan number field.
