 ...
 *
 */
public class RONPS_RDR extends RDR {
	 ...
	 */
	public RONPS_RDR(AllData allData, DataProducts dataProds, FixedDomainDescription dev, int scansPerGranule) throws RtStpsException {
		super(null, RDRName.OMPS_NPScience, allData, dataProds, dev);
		System.out.println("OMPS RDR creation started.");
		this.scansPerGranule = scansPerGranule;
	}
	

	public RONPS_RDR(Stats stats, AllData allData, DataProducts dataProds, FixedDomainDescription dev, int scansPerGranule) throws RtStpsException {
		super(stats, RDRName.OMPS_NPScience, allData, dataProds, dev);
		if (stats == null) {
			System.out.println("OMPS RDR creation started.");
		}
		this.scansPerGranule = scansPerGranule;
	...
	protected RawApplicationPackets createRawApplicationPackets(RDRName rdrName) {
		...
		RawApplicationPackets rap = new RONPSRawApplicationPackets(stats, SpacecraftId.npp, getSetNum(), scansPerGranule, getPacketPool());
