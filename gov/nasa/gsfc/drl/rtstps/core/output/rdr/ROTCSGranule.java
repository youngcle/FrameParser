...
public class ROTCSGranule extends Granule {
	...
	public static void setBaseTimeSet(boolean baseTimeSet) {
		ROTCSGranule.baseTimeSet = baseTimeSet;
	}
	...
	public static void setBaseTime(long baseTime) {
		...
		ROTCSGranule.baseTime = baseTimeEvenSecond;
		System.out.println("Set OMPS baseTime="+ROTCSGranule.baseTime);
		ROTCSGranule.baseTimeSet = true;
	}
	 ...
	 */
	public ROTCSGranule(RawApplicationPackets rap,
					long orbit,
					GranuleId granuleId,
					LEOAFlag leoaState,
					String docName,
	 ...
	 */
	public ROTCSGranule(int groupId, String granuleName) throws RtStpsException {
