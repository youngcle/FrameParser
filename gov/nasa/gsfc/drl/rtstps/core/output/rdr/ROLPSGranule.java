...
public class ROLPSGranule extends Granule {
	
	private final static long endOffset = 37437000L;
	...
	private final static long granuleSize=37437000L;
	...
	public static void setBaseTimeSet(boolean baseTimeSet) {
		ROLPSGranule.baseTimeSet = baseTimeSet;
	}
	...
	public static void setBaseTime(long baseTime) {
		...
		ROLPSGranule.baseTime = baseTimeEvenSecond;
		System.out.println("Set OMPS baseTime="+ROLPSGranule.baseTime);
		ROLPSGranule.baseTimeSet = true;
	}
	 ...
	 */
	public ROLPSGranule(RawApplicationPackets rap,
					long orbit,
					GranuleId granuleId,
					LEOAFlag leoaState,
					String docName,
	 ...
	 */
	public ROLPSGranule(int groupId, String granuleName) throws RtStpsException {
