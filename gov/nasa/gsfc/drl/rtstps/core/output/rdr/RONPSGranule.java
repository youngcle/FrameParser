...
public class RONPSGranule extends Granule {
	
	private final static long endOffset = 37405000L;
	...
	public static void setBaseTimeSet(boolean baseTimeSet) {
		RONPSGranule.baseTimeSet = baseTimeSet;
	}
	...
	public static void setBaseTime(long baseTime) {
		...
		RONPSGranule.baseTime = baseTimeEvenSecond;
		System.out.println("Set OMPS baseTime="+RONPSGranule.baseTime);
		RONPSGranule.baseTimeSet = true;
	}
	 ...
	 */
	public RONPSGranule(RawApplicationPackets rap,
					long orbit,
					GranuleId granuleId,
					LEOAFlag leoaState,
					String docName,
	 ...
	 */
	public RONPSGranule(int groupId, String granuleName) throws RtStpsException {
	...
	public static  long getEndBoundary(long arbitraryTime)
	{
		 ...
		 // ----------------------------------------------------------------------
		   ...
		   // the integer division will give the desired floor value.
		   long granuleNumber = elapsedTime / granuleSize;
		   granuleIDValue = (granuleNumber * granuleSize) / 100000;
		   System.out.println("OMPS granule ID="+granuleIDValue);
		   // Multiply the granule number by the granule size, then add the spacecraft
		   // base time to obtain the granule start boundary time. Add the granule
		   // size to the granule start boundary time to obtain the granule end
		   // boundary time.
