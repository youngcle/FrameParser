...
public class AOSSequencer
{
     ...
     */
    public AOSSequencer(java.util.Collection<StatusItem> statusItemList)
    {
     ...
     */
    public void check(AOS aos)
    {
        if (!aos.isFillFrame())
        {
            int actual = aos.getSequenceCount();
            ...
            else
            {
                ...
                aos.getFrameAnnotation().hasSequenceError = true;
                expected = actual + 1;
            }
